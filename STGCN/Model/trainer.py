...
def model_train(inputs, blocks, args, sum_path='./output/tensorboard'):
    ...
    lr = tf.train.exponential_decay(args.lr, global_steps, decay_steps=5 * epoch_step, decay_rate=0.7, staircase=False)
    ...
    with tf.Session() as sess:
        writer = tf.summary.FileWriter("./output/tensorboard/train", sess.graph)
